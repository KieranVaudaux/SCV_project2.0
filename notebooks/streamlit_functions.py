...
def annual_analysis():
    ...
    st.markdown(r'In order to distinguish more clearly the periods that correspond to a warming or not, we present on the following figure the histogram of the annual anomalies that we have standardised.')
